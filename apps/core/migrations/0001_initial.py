# Generated by Django 4.0.5 on 2022-07-29 22:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('meta_title', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('meta_description', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ...
                ('is_isolated', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meta_tag_type', models.CharField(choices=[('name', 'name'), ('property', 'property'), ('charset', 'charset'), ('http-equiv', 'http-equiv')], default=None, max_length=255)),
                ('meta_tag_key', models.CharField(default=None, max_length=255)),
                ('meta_tag_content', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('meta_model', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='meta_tags', to='core.post')),
            ],
            options={
                'abstract': False,
            },
